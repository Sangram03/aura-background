...
export const metadata: Metadata = {
  ...
  title: "AuraBackground - Modern Background Patterns & Gradients Snippets",
  description:
  ...
  authors: [{ name: "Sangram03", url: "https://github.com/aura-background" }],
  creator: "Megh Bari",
  ...
  applicationName: "AuraBackground",

  // Schema.org structured data hints
  other: {
    "application-name": "Aura-Background",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "Back-Ground",
    ...
    "article:publisher": "https://github.com/sangram03",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              author: {
                "@type": "Person",
                name: "Megh Bari",
                url: "https://github.com/sangram03",
              },
              publisher: {
                "@type": "Organization",
                name: "PatternCraft",
              ...
              sameAs: [
                "https://github.com/Sangram03",
                "https://x.com/sangramdas_1",
                "",
              ],
              featureList: [
