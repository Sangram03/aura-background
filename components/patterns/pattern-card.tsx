...
import { useFavorites } from "@/components/context/favourites-context";
  ...
  return (
    <div className="group relative">
      ...
      >
        ...
        <div className="hidden lg:flex absolute inset-0 cursor-pointer bg-linear-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 items-center justify-center p-4">
